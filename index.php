...
// Als de gebruiker al is ingelogd, doorsturen naar de video's pagina
...
<head>
    ...
    <title>NETFISH - Homepagina</title>
...
<body>
    <!-- Header -->
    <header>
        <a href="index.php"><img src="assets/images/NETFISH-logo.png" alt="NETFISH Logo"></a>
        <nav>
    ...
    <section class="home-film">
        <div class="home-content">
            <h1>Despacito</h1>
            <p class="year">2026</p>
            <p>In een bruisende stad vol muziek en romantiek ontdekken twee onverwachte helden liefde, geheimen en onvergetelijke avonturen terwijl ze hun dromen najagen onder de fonkelende lichten en ritmische beats van de stad.</p>
            <a href="pages/videos.php">Bekijk meer video's</a>
        </div>
        <div class="home-video">
            <iframe width="560" height="315" 
                src="https://www.youtube.com/embed/kJQP7kiw5Fk" 
                title="YouTube video speler" frameborder="0" 
